            ...
            <header ref="anchorTop" class="mb-8">
              <div class="text-center md:text-left">
                ...
                <p class="text-lg text-gray-400">
                  ...
                  brighter digital future, and the Sinners, who despite their influence, hold us
                  back by neglecting this advancement. Dive in as we spotlight these websites,
                  celebrating the innovators and calling out those resisting progress.
                </p>
              </div>
            </header>
