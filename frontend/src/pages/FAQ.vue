                ...
                <ul class="-my-4">
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400">
                      ...
                      the adoption of IPv6 among the 1 Million top-ranked websites and
                      user-submitted campaigns. We offer insightful metrics to help you assess the
                      current landscape of IPv6 implementation.
                    </p>
                  </li>
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400 mb-2">
                      ...
                      sustainable future. As we edge closer to exhausting the IPv4 address space,
                      the immense address capacity of IPv6 becomes indispensable. Beyond the
                      scalability, IPv6 brings along robust security protocols and superior
                      performance, making it the linchpin for modern, efficient, and secure internet
                      communications.
                    </p>
                    <p class="text-md text-gray-400">
                      Failing to adopt IPv6 is tantamount to inhibiting the Internet's evolution.
                      For top websites, this isn't just negligence—it's an abdication of their role
                      as industry leaders. That's why our mission at WhyNoIPv6.com is not just to
                  ...
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400">
                      At WhyNoIPv6.com, we meticulously scan each domain from Tranco's top-ranked
                      list every 3 days to evaluate critical IPv6 adoption metrics. Specifically, we
                      check for the existence of IPv6 DNS records and MX records. The data gleaned
                      from these scans is then aggregated, analyzed, and made publicly available,
                      providing a comprehensive and up-to-date snapshot of IPv6 implementation
                      across influential websites.
                    </p>
                  </li>
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400">
                      ...
                      recognized as a valuable tool for understanding website prominence in a way
                      that accounts for a broader spectrum of internet activity.
                    </p>
                  </li>
                  <li class="py-4">
                  ...
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400">
                      For instance, DNS propagation delays and the dynamic nature of Content
                      Delivery Networks (CDNs) can alter the data based on the anycast DNS location.
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div v-show="page === '2'">
                ...
                <ul class="-my-4">
                  ...
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400 mb-2">
                      Yes, the API is open — no key, no signup. Everything on this site is served
                      from it, at
                    ...
                    <p class="text-md text-gray-400 mb-2">
                      ...
                      <a
                        href="https://api.whynoipv6.com/llms.txt"
                        target="_blank"
                        class="a-gradient"
                        >llms.txt</a
                      >.
                  ...
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400 mb-2">
                      ...
                      <a
                        href="https://api.whynoipv6.com/datasets"
                        target="_blank"
                        class="a-gradient"
              ...
              <div v-show="page === '3'">
                ...
                <ul class="-my-4">
                  ...
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400">
                      <a href="https://www.reddit.com/r/ipv6/" class="a-gradient"
                        >Reddit's r/ipv6</a
                      >
                    </p>
                    <p class="text-md text-gray-400">
                  ...
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400">
                      <a
                        href="https://www.vyncke.org/ipv6status/"
                        target="_blank"
                        class="a-gradient"
                  ...
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400">
                      Become part of a community of like-minded individuals and show your support
                      for IPv6.
                    </p>
                    <p class="text-md text-gray-400 mb-2">
              ...
              <div v-show="page === '4'">
                ...
                <ul class="-my-4">
                  <li class="py-4">
                    ...
                    <p class="text-md text-gray-400 mb-2">
                      Hello! I'm Lasse, Norway's own network maestro, on a personal crusade to
                      spread the magic of IPv6 across every corner of the internet.
                    </p>
                    <p class="text-md text-gray-400 mb-2">
                      By day, I'm a wizard of wires and a sorcerer of switches, tirelessly weaving
                      the intricate web of networks that keep our digital world in motion. By night,
                      I prowl the internet, seeking out IPv6 slackers, nudging them to embrace the
