...
_Frozen 2026-08 — historical design record. The shipped code is the implementation; where it differs, the code and [`docs/adr/`](../adr/) win. **Two exceptions, still canonical:** the §6 glossary (cited by the repo-root `CONTEXT.md`) and the §5 sizing-constants table._
